...
read -p "Press Enter to start Egress Transfer"
...
cd ${GITHUB_PROJECT}
git commit -m "Transfer of masked changes to github for egress ${EGRESS_PREPARE_DATE} as of transfer date ${EGRESS_TRANSFER_DATE}"
